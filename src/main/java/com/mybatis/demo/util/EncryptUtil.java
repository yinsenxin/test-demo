...
//            System.out.println("数据块位数(byte)：" + cipher.getBlockSize());
    ...
    /*public static void main(String[] args) {
        String key="y@gGSDF~·2020`l";
        String test = encryptBase64("test", key);
        System.out.println("加密后的密文"+test);

//       System.out.println("解密后的明文"+decryptBase64(test, key));
        System.out.println("解密后的明文"+decryptBase64("yNj5YO7szSAo6CWNvcyMVWr00vtKhQ4Z8vwjbjLvslw=", key));
    }*/
}